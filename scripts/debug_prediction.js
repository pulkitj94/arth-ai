...
import { initializeVectorStore } from '../server/langchain/vectorStore.js';
import { predictPostPerformance } from '../server/llm/postPredictor.js';
...
async function runDebug() {
    ...
    const mockData = {
        ...
        image: null // Skipping image to focus on baseline calculation first
    };
